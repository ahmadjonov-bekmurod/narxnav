...
function CompanyAbout() {
  ...
  useEffect(() => {
    fetch(`http://185.105.89.222:8080/api/products/?product_company=${categoryName}&ordering=product_price`)
  ...
  return (
    <div>
      ...
      <div className="title-name flex w-full pl-8 sm:w-55 text-4xl font-semibold text-center">
        {t("")}
        {/* <div className="text-slate-400 py-2">{books.company_photo}</div>
        <div className="text-slate-400 py-2">{books.company_name}</div> */}
